...
class FingerSimulation():
    ...
    def load_scene(self):
        ...
        self.finger, = parser.AddModels(
            url='package://finger_description/urdf/setpoint_finger3.urdf')
        self.plant.RenameModelInstance(
            model_instance=self.finger, name='setpoint_finger')
...
def main():
    ...
    ros2drake_system = fingersim.builder.AddSystem(Ros2Drake(node, True))
